    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int x = 0; x < (img1.getWidth()); x++) {
            for (int y = 0; y < (img1.getHeight()); y++) {
                ...
                // Calculate the new red, green and blue values for the pixel by average between two Images
                int rNew = (r2 + r1)/2;
                int gNew = (g2 + g1)/2;
                int bNew = (b2 + b1)/2;
        ...
        ImageIO.write(img1, "jpg", new File("Z:\\citraJava\\AverageTwoImagesTest.jpg"));
    }
}
