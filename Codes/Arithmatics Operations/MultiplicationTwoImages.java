 ...
 * @author agung
 */
public class MultiplicationTwoImages {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int x = 0; x < img1.getWidth(); x++) {
            for (int y = 0; y < img1.getHeight(); y++) {
                ...
                // Calculate the new red, green and blue values for the pixel by multiplication formula
                // 0.1 to prevent error division by zero and get better result
                int rNew = (int) (((double) r2 / 255) * ((double) r1 / 255) * 255);
                int gNew = (int) (((double) g2 / 255) * ((double) g1 / 255) * 255);
                int bNew = (int) (((double) b2 / 255) * ((double) b1 / 255) * 255);
        ...
        ImageIO.write(img1, "jpg", new File("Z:\\citraJava\\MultiplicationTwoImagesTest.jpg"));
    }
}
