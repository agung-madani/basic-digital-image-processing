    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                //set the color of the pixel at (width-1-x, height-1-y) on the new image
                img2.setRGB(width - 1 - x, height - 1 - y, c.getRGB());
            }
        }
        // save modified image to file
        ImageIO.write(img2, "jpg", new File("Z:\\citraJava\\MirrorCartesianTest.jpg"));
